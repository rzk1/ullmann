...
\caption{Adatom catalyzed C--C formation on Cu(111). The energy diagram shows the NEB profile of the reductive elimination simultaneously with adatom escape process. In the structural images, orange, cyan, white, purple spheres represent copper, carbon, hydrogen, iodine atoms, respectively.}
\label{fig:AlterPath}
\end{figure*}

...
ZZ0811: it includes Cu(110), not all are 111 surfaces}
\begin{tabular}{ lcccccc }
 \hline
 \hline
 \multicolumn{7}{c}{Temperature for the Ullmann coupling steps } \\
 \hline
 ...
 \hline
 Iodobenzene (\si{\kelvin})               &175\cite{sur_sci01} &200\cite{sur_sci02} &200-250\cite{sur_sci03} &350\cite{ullmann_68} &300-370\cite{ullmann_68} &250\cite{sur_sci03}\\
 Bromobenzene (\si{\kelvin})  &160\cite{ullmann_67} &$\leq$ 197\cite{sur_sci02}  &  &350\cite{ullmann_67}  &$\leq$ 350\cite{sur_sci02}  & \\
 Dichlorobenzene (\si{\kelvin}) &420\cite{ullmann_52} & & &470\cite{ullmann_52} & & \\
 Dibromobenzene (\si{\kelvin})  &$\leq$ 300\cite{ullmann_52} & & &470\cite{ullmann_98}  & & \\
 Diiodobenzene (\si{\kelvin})   &$\leq$ 300\cite{ullmann_52} & & &500 \cite{ullmann_88} & & \\
 \hline
 \hline
\end{tabular}

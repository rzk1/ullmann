%\documentclass[aps,prb,reprint,amsmath,amssymb,floatfix]{revtex4-1}
%\documentclass[aps,prb,amsmath,amssymb,floatfix,notitlepage,11pt]{revtex4-1}
\documentclass[journal=jpclcd,layout=traditional,manuscript=letter]{achemso} % JPCL
...
\setlength{\tabcolsep}{2pt} % distance between table columns
\renewcommand{\arraystretch}{1.6} % distance between table rows

...
%
%The line of thermoneutral extraction (TNE) is calculated by fitting a straight line to several points of TNE. The point of TNE is a point in the RZK space at which the phenyl-assisted adatom extraction from the surface of a hypothetical metal has precisely zero energy. 
%
%Points of TNE are calculated from DFT data for each metal by lowering the clean-surface adatom extraction energy by the energy of the phenyl-assisted adatom extraction.
%
%from the  calculated for a hypothetical metal in the assumption lowering the clean-surface extraction  that the using the actual energy of adatom extraction for a given metal

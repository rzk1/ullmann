...
The raise of this magnitude (cf. \SI{1.41}{\angstrom} radius of gold atom {\comm[RZK0819: Calculate the radius from interatomic distances on the surface]}) is high enough to warrant further exploratory studies of the adatom creation.
...
%\caption{Energy diagram of \textbf{DHAL-2}, \textbf{CMC}, \textbf{X-CMC$\ddagger$} and \textbf{X-CMC} from the Ullmann reaction of bromobenzene, top line is the energy of isolated Cu(111) surface geometry in corresponding intermediates, and the bottom line is the energy of intermediates in Fig.~\ref{fig:completeenergy}.}
\caption{
...
{\comm RZK0527: We should discuss implications beyond the Ullmann coupling.}% For example, creation of adatom covered surfaces and design of ``adatom pumps''.}

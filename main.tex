...
%RZK0818: In panel (a) the Au figure is still not in the vector format. Cu and Ag are in vector format.
...
%RZK0818: There are multiple corrections required:
%The quality of (b) is poor. The resolution is too low.(done) The (b) must be in vector format, as most other figures.
\end{figure*}
...
%RZK0818: Abbrevite all journal names (this can be done in the software that generates your bib file). See any ACS Nano article for proper formatting. Check all references one-by-one. They must be displayed correctly.

...
{\color{blue}
On-surface polymerization is a rapid-developing field aimed at achieving the constructions of unprecedented 1D or 2D polymers with novel structures and revolutionary properties\cite{ullmann_105, ullmann_33, ullmann_70}. Unique electronic or spin characteristics of functional materials such as graphene nanoribbons\cite{ullmann_106, ullmann_45, ullmann_107, ullmann_101}, hexagonal boron-nitride\cite{ullmann_110, ullmann_111, ullmann_112} and other 2D polymers\cite{ullmann_108, ullmann_109} make them promising candidates to produce a variety of electronic and optoelectronic device\cite{ullmann_113, ullmann_114}.
...
%RZK0423: Any other reviews to add to the citation list above? (ZZ:added)
...
%RZK0423: Dima's comment about the following sentence: "there was a series of Bent's papers on Ullmann. cite others, too." If necessary change to "by Brent~\textit{et al.}~\cite{sur_sci01, others}." Do not include the year. (ZZ: modified and added)
{\color{blue}
One of the first fundamental studies of the surface-confined coupling of iodobenzene to biphenyl under ultrahigh vacuum (UHV) condition was reported by Bent~\textit{et al.}~\cite{sur_sci01} with a series of pioneer and extended exploration\cite{ullmann_127, ullmann_128, ullmann_129, ullmann_87}.
%
The intermediate species of the same reaction were inspected using STM imaging then by Weiss \textit{et al.}~\cite{langm01}. 
Later, it was demonstrated that linear \emph{protopolymers}---aligned monomer units that have not yet reacted to form the final polymer---could be obtained by depositing \textit{para}-diiodobenzene on Cu(111) at 77 K~\cite{jacs01}. 
}
%
...
And Grill \textit{et al.} have prepared patches of a two-dimensional polymer from \textit{tetrakis}(bromophenyl)porphyrin on the Au(111) surface.
...
{\color{blue}
The challenges of on-surface Ullmann reactions also draw much attention after three decade development: (a) tuning properties of these materials to the desired range by modifying their atomic composition and structure, (b) cost-effective synthesis of 2D polymers free of defects and with larger size. (c) 
}

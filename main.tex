...
RZK0426: The result reported in pccp2010 for ideal-surface step is very different from our results. In their article this step is exothermic. This needs to be mentioned and perhaps discussed extensively. (ZZ: added)
...
RZK0422: The alternative transition states must be described. What is the energy barrier with the alternative TS compared to that with X-DIM-ddagger? (ZZ: will add later)
...
Desorping biphenyl molecule requires \SI{1.72}{\electronvolt} of energy, corresponding to increasing the annealing temperature \SI{100}{\kelvin} higher than coupling temperature to remove biphenyl on Cu(111). 
...
Such a high energy requirement becomes a nasty issue for practical surface Ullmann coupling. The dissociated halogen atoms will remain on metal surface and impedes the further diffusion of chemical species for coupling. Removing the halogens can effectively optimize the speed and quality of synthesizing polymer structure using surface Ullmann coupling.
}

...
%RZK: Refer the reader to the barrier discussion in SI.
...
%{\zhzh Although the equilibrium concentration of adatoms on surfaces is expected to be small due to the high energy of their formation~\cite{chemeurope2017}, such pre-existing}
{\zhzh Adatoms have been known to form on copper, silver and gold surfaces~\cite{ullmann_79, ullmann_58} near terrace edges, kinks in the process of the thermal motion of metal atoms~\cite{ullmann_84, ullmann_85, ullmann_171}. Such pre-existing adatoms have also been found to participate in metal organic coordination networks~\cite{ullmann_80, ullmann_81, ullmann_82, ullmann_83, ullmann_170}.}
...
In the second pathway, the Cu atom is pulled out \sout{from the topmost metal layer} to become an adatom, leaving a vacancy in its original position. This pathway is called the {\zhzh phenyl-assisted} adatom pathway.
...
{\zhzh In addition to the C--C bond formation mechanism describe above, we explored an alternative pathway that proceeds from \textbf{X-CMC} directly to \textbf{X-DIM-B} without passing through \textbf{X-DIM-A}. In this pathway, the formation of the C--C bond and the separation of the adatom and biphenyl happen simultaneously rather than sequentially. It was found that this path has the activation energy of \SI{3.0}{\electronvolt} indicating that such a transformation is unrealistically slow (Figure~\ref{SI-fig:AlterPath}).}
...
In contrast to the C--C bond formation on the ideal surface, the energy release along this step of the {\zhzh phenyl-assisted} adatom pathway is moderate \SI{-0.48}{\electronvolt} (\textit{cf.} \SI{-2.00}{\electronvolt} on the ideal surface) while the barrier height is the prohibitive \SI{1.78}{\electronvolt} (\textit{cf.} \SI{0.49}{\electronvolt}). 

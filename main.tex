...
\caption{The dissociation of C-Br bond on Cu(111) surface. Left is the energy diagram of the CI-NEB calculations, right side are the top and side views of geometry of $IS$, $TS$ and $FS$. (Sphere with yellow color is copper atom, with cyan color is carbon atom, with white color is hydrogen atom, with red color is bromine atom)}
\label{fig:dissociation_Br}
\end{figure*}

{\lock

Fig.~\ref{fig:dissociation_Br} shows the structures of the initial, transition and final states for the debromination of the physisorbed bromobenzene on Cu(111). These state are labeled as PHYS, DHAL$^\ddag$ and DHAL in Fig.~\ref{fig:completeenergy}. Dechlorination and deiodination have similar energy and geometry change trend (see supporting information for the figures of dechlorination and deiodination).

}{\color{blue}

[RZK0317: The logic of the paragraph below is not clear]

The energy change of the dehalogenation step is computed to be \SI{-0.58}{\electronvolt}, \SI{-0.80}{\electronvolt} and \SI{-0.94}{\electronvolt} for chlorobenzene, bromobenzene and iodobenzene, respectively. [RZK0317: Unlike analogous reactions in the solution?], dehalogenation on the copper surface is exothermic. [RZK:] DFT results have demonstrated that the $E_{barrier}$ of nucleophilic substitution of chlorobenzene and bromobenzene in solution are \SI{1.11}{\electronvolt} and \SI{1.18}{\electronvolt}~\cite{ullmann_86}. The discrepancy in energy indicates that the dehalogenation reaction should go through different mechanisms on Cu(111) surface and in solution. 
...
\begin{tabular}{ |p{2.3cm}|p{1.6cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}|  }
 \hline
 \multicolumn{5}{|c|}{Bond length of intermediates states in dehalogenation (\si{\angstrom}) } \\
 \hline
 \multirow{2}{*}{Precursor} & \multirow{2}{*}{Bond type} & \multicolumn{3}{|c|}{Intermediate states} \\ \cline{3-5} & & PHYS & DHAL$^\ddag$ & DHAL \\ \cline{1-5}
...
RZK0317: In the paragraph below, more numerical data must be presented in a Table and less in the text. Text should discuss main trends.

In addition to the energy data, the geometry of intermediates in dehalogenation are also obtained and summarized. As shown in Fig.~\ref{fig:dissociation_Br}, the distances between carbon and halogen which are going to break a covalent bond, the angle of phenyl ring with respect to surface are both suffering successively changes. In IM1 of chlorobenzene, bromobenzene and iodobenzene, the distance between carbon and halogen is \SI{1.74}{\angstrom}, \SI{1.91}{\angstrom} and \SI{2.12}{\angstrom}. These values are consistent with the calculated bond length of C--Cl (\SI{1.76}{\angstrom}), C--Br (\SI{1.91}{\angstrom}) C--I (\SI{2.14}{\angstrom})in gas phase based on B3LYP functional DFT calculations. C--Cl, C--Br and C--I distances have increased by \SI{0.44}{\angstrom}, \SI{0.55}{\angstrom} and \SI{0.49}{\angstrom} in transition state TS1 compared to the original carbon halogen bonds, respectively. Finally the dehalogenation will end in relatively stable IM2, dissociated halogen atoms occupy the hollow site on Cu(111) surface. The distance between C--Cl, C--Br and C--I increase to \SI{3.99}{\angstrom}, \SI{4.10}{\angstrom} and \SI{5.10}{\angstrom} in respective IM2. The phenyl ring part of chlorobenzene, bromobenzene and iodobenzene are all mostly parallel to surface with adsorbed on copper before the dehalogenation. And in the dissociation, the phenyl ring starts to become tilt on surface, then finalize at a large slope. This indicates that the unsaturated carbon atom is interacting with copper atom in Cu(111) during the dehalogenation process. The interaction also changes the distance between the unsaturated carbon and the copper atom involved in dehalogenaiton. In IM1, the distance between the carbon in C-X and the copper atom beneath is \SI{3.54}{\angstrom}, \SI{3.40}{\angstrom} and \SI{3.42}{\angstrom} for chlorobenzene, bromobenzene and iodobenzene, respectively. After dehalogenation, the distance reduces to \SI{2.01}{\angstrom} for all three cases, and the copper atom involved in dehalogenation are all raised by \SI{0.10}{\angstrom} from their original positions. The same C--Cu distance in the end of dehalogenation of chlorobenzene, bromobenzene and iodobenzene suggest that the dissociated halogen atoms have little effect on the interaction of unsaturated carbon and copper atoms. However, halogen atoms have a much larger influence on phenyl ring, resulting in different tilt angles of dehalogenated aromatic species, deiodinated phenyl ring is inclined around \SI{70}{\degree} to metal surface, larger than debrominated and dechlorinated phenyl rings both at around \SI{50}{\degree}.
...
%
In the TS1, the geometry of chlorobenzene, bromobenzene and iodobenzene on Cu(111) are similar, forming a tilt angle, ready for the break of C-X, the distance of C-X are 2.18 \si{\angstrom}, 2.46 \si{\angstrom} and \si{2.61 \angstrom}, respectively. 
%R1111: Report bond elongations, not only bond lengths.
After dehalogenation, the phenyl species and halogen atoms were separately chemisorbed by Cu(111) surface. In IM2, the distance between the carbon and halogen are increased by 1.81 \si{\angstrom}, 1.64 \si{\angstrom} and 2.49 \si{\angstrom} compared to original distance, respectively. The geometry of IM2 for chlorobenzene, bromobenzene are similar, in which the phenyl species displayed a more tilt angle with the copper surface compared to the TS1. 
...
Fig
%.~\ref{fig:organometallicintermediate} 
...
The energy profile of the first pathway is shown by the RYK-color line in Fig.~\ref{fig:completeenergy} whereas the results of the NEB calculations are presented in Fig.~\ref{fig:bondformlift}. The transition and final states of this step are denoted as \textbf{DIM$\ddagger$} and \textbf{DIM}, respectively.
...
\caption{C-C bond formation with the copper atom returning to its original position. Left diagram is CI-NEB calculation, right part is the top and side view of $IM4$, $TS-g$, and $Dim-g$ in Fig.~\ref{fig:completeenergy}, sphere colors are set same as above. RZK0324: The initial energy is that of the \textbf{CMC} state with bromine as the halogen.}
...
Fig.~\ref{fig:IM4_TS} shows first trajectory from IM4 to the C--Cu--C bridge intermediates with a fully extracted Cu adatom (IM-r1). In IM-r1, there is a vacancy on the original location of newly formed adatom. 
$\Delta E$ and $E_{barrier}$ of the first step are \SI{-0.20}{\electronvolt} and \SI{1.38}{\electronvolt}. The distance between two carbons forming C--Cu--C bridge increases to \SI{3.89}{\angstrom} (in IM-r1) from \SI{3.10}{\angstrom}, and cuts down by \SI{0.34}{\angstrom} in the transition state. The tilt angle flattens to \SI{13}{\degree} from \SI{34}{\degree}.

Fig.~\ref{fig:bondformadatom} displays the NEB energy diagram and the key intermediates configurations from IM-r1 to dimer formed on top of the newly formed adatom (Dime-r1).
$\Delta E$ and $E_{barrier}$ of this step are \SI{-0.17}{\electronvolt} and \SI{2.01}{\electronvolt}. It ends in the formation of a new covalent C--C with a bond length at \SI{1.50}{\angstrom}, the former distance between these two carbons is \SI{3.10}{\angstrom} in IM-r1, and condenses by \SI{0.57}{\angstrom} in transition state. The tilt angle in Dim-r1 is a little twisted to \SI{-9.1}{\degree}. The configuration of biphenyl should be a nearly plane structure, this can be explained by the fact that the new formed C--C is directly on the top of fully extracted Cu adatom. The distance from the Cu adatom to formed C--C bond is \SI{1.66}{\angstrom}, leading to the repulsion force and distort the two phenyl ring to such a degree.
...
\caption{Energy diagram of IM3, IM4 and IM-r1, top line is the energy of pure Cu(111) surface geometry in IM3, IM4 and IM-r1, and the bottom line is the energy of Ullmann reaction species on surface.}
...
\caption{Full extraction of an ideal surface Cu atom out in Path II. Left diagram is CI-NEB calculation, right part is the top and side view of $IM4$, $TS-r1$, and $IM-r1$ in Fig.~\ref{fig:completeenergy}, sphere colors are set same as above.}
\label{fig:IM4_TS}
\end{figure*}
...
\caption{C-C bond formation through new formed adatom Path II. Left diagram is CI-NEB calculation, right part is the top and side view of $IM-r1$, $TS-r2$, and $Dim-r1$ in Fig.~\ref{fig:completeenergy}, sphere colors are set same as above.}
...
However, the evidence in geometry provides a different result. In experiment, the distance between two carbons in C--Cu--C bridge structure is \SI{4.5}{\angstrom} \textpm\ \SI{0.6}{\angstrom} based on the STM image of this bridge intermediates. This corresponds to the distance in IM-r1 of path II, which is \SI{3.89}{\angstrom}, and this distance in IM4 is \SI{3.10}{\angstrom}. This means that the C--Cu--C intermediates is more likely to possess an adatom in nature, this adatom is either from an ideal surface or it is an pre-existing adatom.

Taking the reaction condition into consideration. The temperature of final forming C--C bond from two phenyl species need to go up to above \SI{350}{\kelvin}~\cite{sur_sci01}. The activation energy of IM4 evolved to TS-g in green line and to TS-r1 in red line are \SI{0.38}{\electronvolt} and \SI{1.37}{\electronvolt}, respectively. The experimental temperature can meet the requirement of both two paths, but the reaction in path II will occur with a higher speed.

}
Taking the data of Path I and Path II into consideration, finally, a feasible C--C bond was constructed in both cases (bond length is around 1.5 \si{\angstrom}, expected to be 1.34 \si{\angstrom} - 1.54 \si{\angstrom}. From thermodynamic aspect, Path I is much more exothermic, which means it will lead to a more stable product. Kinetically, the activation energy of Path I is also smaller than Path II, which means at the same temperature, the Path I reaction would take place at a higher speed and account for a much larger percentage. In this case, we could safely conclude that, if there is no pre-exiting adatom on copper surface, the formation of C--C bond in surface Ullmann coupling will follow the path I.
...
\begin{figure*}[hbt]
\centering
\includegraphics[width=0.98\textwidth]{Fig/Chlorine-all.png}
\caption{The energy diagram of chlorobenzene on Cu(111) surface Ullmann coupling reaction. The red line is the surface Ullmann coupling reaction following Path II, the green line is following Path I. Finally, red line ends with an adatom-vacancy pair on Cu(111) surface and the green line ends same as the original Cu(111) surface. (Yellow circle represents chlorine atom).}
\label{fig:Clfinal}
\end{figure*}
...
\caption{The energy diagram of bromobenzene on Cu(111) surface Ullmann coupling reaction with a pre-existing adatom. (Scarlet circle represents bromine atom). RZK0324: important transition state(s) are missing.}

...
Like previous drawn conclusion, Ullmann reaction is also interrupted at C--Cu--C organometallic intermediate with a pre-existing adatom. Compared to C--C bond formation, the intermediate prefers to diffuse and refill nearby vacancy site, and proceed to biphenyl with a ideal surface copper atom catalyse.
}
...
Our study suggests that the entropy contribution to free energy can affect the process of surface Ullmann coupling.The entropy calculation depends much on surface coverage, temperature and pressure, a highly consistent reaction condition parameter setup allows more accurate results in DFT calculations. However, our model for two dimensional lattice adsorption is a superficial model, aimed at providing insight into narrowing the gap between theoretical calculation and experiment. 
}
\begin{figure*}[hbt]
\centering

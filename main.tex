...
RZK0324: Almost all sections contain blue and black text, with the black being an old copy of the blue. Why keep old text? Erase all unused parts of the old text.
...
%RZK0317: State labels must be discussed and changed.
...
It should be noted that the dehalogenation of bromobenzene and iodobenzene on Cu(111) has been investigated previously~\cite{jacs2013} using optB86b exchange-correlation functional and smaller slab size. The energy change and barrirer of this step are \SI{-0.70}{\electronvolt} (bromobenzene), \SI{-0.82}{\electronvolt} (iodobenzene) and \SI{0.72}{\electronvolt} (bromobenzene), \SI{0.40}{\electronvolt} (iodobenzene). 
RZK0317: Any comments?
...
\begin{table}
\centering
\begin{tabular}{ |p{2.3cm}|p{1.6cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}|  }
 \hline
 \multirow{2}{*}{Precursor} & \multirow{2}{*}{Bond type} & \multicolumn{3}{|c|}{Intermediate states (\si{\angstrom})} \\ \cline{3-5} & & \textbf{PHYS} & \textbf{DHAL$\ddagger$} & \textbf{DHAL} \\ \cline{1-5}
 \multirow{2}{*}{Chlorobenzene} & C--Cl & 1.74 & 2.18 & 3.99 \\ \cline{2-5}
 & C--Cu &3.54 & & 2.01 \\ \cline{1-5}
 \multirow{2}{*}{Bromobenzene} & C--Br & 1.91 & 2.46 & 4.10 \\ \cline{2-5}
 & C--Cu &3.40 & & 2.01 \\ \cline{1-5}
 \multirow{2}{*}{Iodobenzene} & C--Br &2.12 & 2.61 & 5.10 \\ \cline{2-5}
 & C--Cu &3.42 & & 2.01 \\ \cline{1-5}

\end{tabular}
\caption{Bond length of intermediates states in dehalogenation}
...
RZK0317: Do we need any of the black text of this section below? 
...
Fig.~\ref{fig:IM4_TS} shows first trajectory from \textbf{CMC} to the C--Cu--C bridge intermediates with a fully extracted Cu adatom (\textbf{X-CMC}). In \textbf{X-CMC}, there is a vacancy on the original location of newly formed adatom. 
Energy change and barrier of this step are \SI{-0.20}{\electronvolt} and \SI{1.38}{\electronvolt}. The distance between two carbons forming C--Cu--C bridge increases to \SI{3.89}{\angstrom} (in \textbf{X-CMC}) from \SI{3.10}{\angstrom}, and cuts down by \SI{0.34}{\angstrom} in the \textbf{X-CMC$\ddagger$}. The tilt angle flattens to \SI{13}{\degree} from \SI{34}{\degree}.

Fig.~\ref{fig:bondformadatom} displays the NEB energy diagram and the key intermediates configurations from \textbf{X-CMC} to dimer formed on top of the newly formed adatom (\textbf{X-DIM-A}).
Energy change and barrier of this step are \SI{-0.17}{\electronvolt} and \SI{2.01}{\electronvolt}. It ends in the formation of a new covalent C--C with a bond length at \SI{1.50}{\angstrom}, the former distance between these two carbons is \SI{3.10}{\angstrom} in \textbf{X-CMC}, and condenses by \SI{0.57}{\angstrom} in \textbf{X-DIM$\ddagger$}. The tilt angle in \textbf{X-DIM-A} is a little twisted to \SI{-9.1}{\degree}. The configuration of biphenyl should be a nearly plane structure, this can be explained by the fact that the new formed C--C is directly on the top of fully extracted Cu adatom. The distance from the Cu adatom to formed C--C bond is \SI{1.66}{\angstrom}, leading to the repulsion force and distort the two phenyl ring to such a degree.
...
{\color{blue}
The summary of thermodynamic data of all intermediates in surface Ullmann coupling of chlorobenzene, bromobenzene and iodobenzene are present in Fig.~\ref{fig:Clfinal}, Fig.~\ref{fig:completeenergy} and Fig.~\ref{fig:Ifinal}.
...
\begin{figure*}[hbt]
\centering
\includegraphics[width=0.98\textwidth]{Fig/ullmann_adatom.png}

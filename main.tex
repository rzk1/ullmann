...
$E_{barrier}$ of dehalogenation on surface decrease by the order C--Cl $>$ C--Br $>$ C--I. In experiment on Cu(111), C--I bond of iodobenzene will dissociate at \SI{175}{\kelvin}~\cite{ullmann_87}, C--Br bond of iodobenzene will be at \SI{160}{\kelvin}~\cite{ullmann_67}. There was no data for chlorobenzene dehalogenated on copper surface, but a \SI{390}{\kelvin} temperature condition must be reached for dichlorobenzene to completely dissociate both chlorine atoms\cite{ullmann_52}. And it can be inferred that C--Cl will break at a higher temperature than C--Br and C--I. The trend in experimental temperature is well corresponding to the data in simulation results.
Similar procedure has also been investigated previously~\cite{jacs2013}, which offered the value for $\Delta E$ and $E_{barrier}$ of dehalogenation of bromobenzene and iodobenzene on Cu(111), $\Delta E$ are \SI{-0.70}{\electronvolt} and \SI{-0.82}{\electronvolt} and $E_{barrier}$ are \SI{0.72}{\electronvolt} and \SI{0.40}{\electronvolt} with optB86b exchange-correlation functional and smaller slab size.

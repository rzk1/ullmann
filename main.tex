...
{\comm (need modification The strong binding of halobenzene on metal surface is primarily due to the van der Waals interaction of (a) the $\pi$-system and (b) halogens with the metal surface. For example, the energy of interaction between biphenyl and copper is \SI{1.72}{\electronvolt} whereas Br$_2$ molecule interacts with the surface by \SI{4.08}{\electronvolt}.
}
}
...
Contrary to surface-confined condition, dehalogenation of bromobenzene and iodobenzene in gas phase require \SI{3.85}{\electronvolt} and \SI{3.33}{\electronvolt} energy to accomplish~\cite{jacs2013}. This means copper surface can stabilize and denote electrons to dissociated species, which will make this reaction energetically favourable on Cu(111).  

}{\lock

The energy barrier of the dehalogenation on surface decreases from chlorobenzene (\SI{1.24}{\electronvolt}) to bromobenzene (\SI{0.89}{\electronvolt}) and to iodobenzene (\SI{0.63}{\electronvolt}). This trend is in agreement with the trend of experimentally measured temperatures required to complete dehalogenation. On Cu(111), iodobenzene has been observed to dissociate at \SI{175}{\kelvin}~\cite{ullmann_87}, while bromobenzene dissociates at \SI{160}{\kelvin}~\cite{ullmann_67}. There is no data referred to dehalogenation temperature of chlorobenzene, but it can be inferred from the existing data of dihalogenated precursors (Table~\ref{table:exp-temp}) that chlorobenzene dissociates at significantly higher temperature than bromobenzene and iodobenzene.
{\color{blue}
Previous DFT calculations have demonstrated that the free energy barrier of nucleophilic substitution of chlorobenzene and bromobenzene in solution are \SI{1.11}{\electronvolt} and \SI{1.01}{\electronvolt}~\cite{ullmann_86}. The break of C--Cl also requires a higher energy than the break of C--Br in solution.
}

RZK0317: Bell-Evans-Polanyi principle?

It should be noted that the dehalogenation of bromobenzene and iodobenzene on Cu(111) has been investigated previously~\cite{jacs2013} using optB86b exchange-correlation functional, the molecular orientation of bromobenzene and dissociated phenyl radical on Cu(111) are identical with our model. The energy change and barrier reported are \SI{0.66}{\electronvolt} and \SI{-0.68}{\electronvolt} (bromobenzene), \SI{0.40}{\electronvolt} and \SI{-0.81}{\electronvolt} (iodobenzene).
%RZK0317: Any comments? (ZZ: added)
%RZK0415: Did they study the same orientation of the molecule? (ZZ: yes, almost the same)
{\color{blue}
The trend of energy change and activation energy for different halogens are consistent with our conclusion, the difference between energy change and activation energy are also close to our results, which could be supported by Bell-Evans-Polanyi principle. The slight difference in the energy value can be interpreted by different functional usage and our larger slab model for computation.
...
Selected geometric parameters of the intermediates have been summarized in Table~\ref{table:bondlength}. As shown in Fig.~\ref{fig:dissociation_Br}, the distances between carbon and halogen which are going to dissociate a covalent bond, the angle of phenyl ring with respect to surface have both suffered successively changes. In \textbf{PHYS} of halobenzene, the distance between carbon and halogen is consistent with the calculated bond length of C--Cl (\SI{1.76}{\angstrom} of chlorobenzene), C--Br (\SI{1.91}{\angstrom} of bromobenzene) C--I (\SI{2.14}{\angstrom} of iodobenzene) in gas phase based on B3LYP functional DFT calculations. These distances will show a continued growth till \textbf{DHAL} states, and dissociated halogen atoms occupy the hollow site on Cu(111) surface in the end of dehalogenation. Interestingly, in the \textbf{DHAL$\ddagger$} transition states of all three halobenzene precursors, C--X distance shows a consistent approximately \SI{0.5}{\angstrom} longer than C--X in \textbf{PHYS}, suggesting that different dehalogenation reactions on Cu(111) follow identical mechanism.
The phenyl ring parts of three halobenzenes are all mostly parallel to surface once adsorbed on copper before the dehalogenation. And in the dissociation, the phenyl rings start to become tilt on surface, then finalize at a large slope. This indicates that the unsaturated carbon atom is interacting with copper atom in Cu(111) during the reaction process. The interaction also changes the distance between the unsaturated carbon and the copper atom involved in dehalogenation from different starting values in \textbf{PHYS} to the same \SI{2.01}{\angstrom} in \textbf{DHAL} states, and the copper atom involved in dehalogenation are all raised by \SI{0.10}{\angstrom} from their original positions. The same C--Cu distances in the end of dehalogenation of chlorobenzene, bromobenzene and iodobenzene suggest that the dissociated halogen atoms have little effect on the interaction of unsaturated carbon and copper atoms. However, halogen atoms have a much larger influence on phenyl ring, resulting in different tilt angles of dehalogenated aromatic species, deiodinated phenyl ring is inclined around \SI{70}{\degree} to metal surface, larger than debrominated and dechlorinated phenyl rings both at around \SI{50}{\degree}.

}

RZK0317: Discuss the role of adatoms in the dehalogenation step. Our results and/or old results can be discussed. Old results can be discussed briefly since they are already presented in the introduction.

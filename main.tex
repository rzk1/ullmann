...
\caption{Examples of the Ullmann coupling reactions. Adapted from Ref.~\cite{ullmann_30}}
...
The adsorption energies calculated in this work for a single molecule of chlorobenzene, bromobenzene and iodobenzene on Cu(111) are \SI{-1.06}{\electronvolt}, \SI{-1.18}{\electronvolt} and \SI{-1.37}{\electronvolt}, respectively. 
...
The strong binding of halobenzenes on surface is primarily due to the interaction of (a) the $\pi$-system and (b) halogens with metal surface. For example, the energy of interaction between biphenyl and the metal is \SI{1.72}{\electronvolt} whereas Br$_2$ molecule interacts with the surface by \SI{4.08}{\electronvolt}.
...
The energy barrier of the dehalogenation on surface decreases from chlorobenzene (\SI{1.25}{\electronvolt}) to bromobenzene (\SI{0.92}{\electronvolt}) and to iodobenzene (\SI{0.68}{\electronvolt}). This trend is in agreement with the trend of experimentally measured temperatures required to complete 
%(RZK0317: or complete?) ZZ: changed
dehalogenation. On Cu(111), iodobenzene has been observed to dissociate at \SI{175}{\kelvin}~\cite{ullmann_87} while bromobenzene dissociates at \SI{160}{\kelvin}~\cite{ullmann_67}. There is no data the dehalogenation temperature of chlorobenzene, but it can be inferred from the existing data on dihalogenated precursors (Table~\ref{table:exp-temp}) that chlorobenzene dissociates at significantly higher temperature than both bromobenzene and iodobenzene. 
...
\begin{tabular}{ llccccc  }
 \hline
 \hline
 Property & X & \textbf{PHYS} & Increase & \textbf{DHAL$\ddagger$} & \textbf{DHAL} & Change \\ 
 \hline 
 \multirow{3}{*}{C--X (\si{\angstrom})} & Cl & 1.74 & +0.44 & 2.18 & 3.99 & \\ 
 %\cline{2-5}
 & Br & 1.91 & +0.55 & 2.46 & 4.10 & \\ 
 %\cline{2-5}
 & I & 2.12 & +0.49 & 2.61 & 5.10 & \\ 
 %\cline{2-5}
 \hline
 \multirow{3}{*}{C--Cu (\si{\angstrom}) } & Cl & 3.54 & minus & & 2.01 & \\ 
 & Br & 3.40 & & & 2.01 & \\ 
 & I &3.42 & & & 2.01 & \\ 
 \hline
 \multirow{3}{*}{E (\si{\electronvolt}) } & Cl &  & 1.25 & & & -0.58\\ 
 & Br & & 0.92 & & & -0.80\\ 
 & I  &  & 0.68 & & & -0.94 \\ 
 \hline
 ...
 \hline
\end{tabular}
\caption{Geometric and energetic characterization of the dehalogenation step. X denotes the halogen atom. Energies are reported relative to the \textbf{SURF} state. RZK0415: Why some distance cells are empty? Add distance Cu* to X? Any other state-related data in addition to bond lengths, perhaps energies? Deltas between states: TS-PHYS (increase) and DHAL-PHYS (last column)? Deltas between halogens (in parenthesis) are also important.}
...
RZK0317: Discuss our results on adatom role.
...
{\color{blue}
The summary of thermodynamic data of all intermediates in surface Ullmann coupling of chlorobenzene, bromobenzene and iodobenzene are present in  Fig.~\ref{fig:completeenergy} and 
...
%\caption{The energy diagram of bromobenzene on Cu(111) surface Ullmann coupling reaction. The red line is the surface Ullmann coupling reaction following Path II, the green line is following Path I. Finally, red line ends with an adatom-vacancy pair on Cu(111) surface and the green line ends same as the original Cu(111) surface. (Scarlet circle represents bromine atom).}
%\label{fig:completeenergy}
%\end{figure*}
%
%\begin{figure*}[hbt]
%\centering
%\includegraphics[width=0.98\textwidth]{Fig/Iodine-all.png}
%\caption{The energy diagram of iodobenzene on Cu(111) surface Ullmann coupling reaction. The red line is the surface Ullmann coupling reaction following Path II, the green line is following Path I. Finally, red line ends with an adatom-vacancy pair on Cu(111) surface and the green line ends same as the original Cu(111) surface. (Red circle represents bromine atom).}
%\label{fig:Ifinal}
%\end{figure*}
...
As Figure.~\ref{fig:pureadatomform} shows, the reaction of forming a new adatom-vacancy pair on perfect Cu(111) surface is endothermic, energy change is 1.76 eV and the energy barrier is 2 eV. This means at room temperature, the formation of adatom is unfavourable. 
...
\caption{Adatom formation on a clean Cu(111) surface. RZK0326: This figure is uninformative and should be (a) either reformatted to show the position of the vacancy and placed into SI or (b) removed completely.}

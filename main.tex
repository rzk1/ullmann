...
%RZZK The increased binding strength makes the formation of the carbon-carbon bond between the two phenyl group extremely difficult. High barrier and no energy release.

%RZZK The two phenyl groups bound to the extracted adatom can still participate in the coupling process if the adatom recombines with the vacancy -- the step that is found to have relatively low activation energy.

%RZZK: A simple discussion on pre-existing adatom affecting on-surface Ullmann reaction has also been present. 

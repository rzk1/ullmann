...
{\color{blue}
It has been reported previously that the adsorption energy for bromobenzene and iodobenzene on Cu(111) are \SI{-0.95}{\electronvolt}, \SI{-1.12}{\electronvolt} with optB86b correlation-exchange functional in DFT and a smaller slab size~\cite{jacs2013}. The iodine atom diminishes the adsorption energy by \SI{0.17}{\electronvolt} compared to bromine atom. This decrease is consistent with our calculation results (\SI{0.19}{\electronvolt}). 
}

...
The formation of carbon--metal--carbon intermediates from two infinitely separated phenyl radicals, which are assigned \textbf{CMC} and \textbf{DHAL-2} labels respectively, is slightly endothermic. Experimentally, the dehalogenation and formation of the bridge structure occur at the same temperature (Table~\ref{table:exp-temp}) indicating that only a small energy barrier needs to be overcome for the two phenyl groups to approach each other~\cite{pccp2010}. 

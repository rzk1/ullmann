...
\caption{Top and side view of the initial, transition and final geometries of BrFL molecule diffuse. Adapted from Ref.~\cite{jpcc2018}}
\label{fig:diff}
\end{figure}

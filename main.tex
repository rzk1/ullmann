...
%RZK0618: "The Ullmann coupling" OR "Ullmann coupling"?
...
Surface-confined reactions such as Ullmann and Glaser coupling, decarboxylation and dehydorgenation reactions, Bergman cyclization~\cite{giovannantonio2018reversibility}
...
%
Ullmann coupling of aryl halides on metal surfaces -- often copper, silver and gold -- is one of the most used polymerization reactions. It has received its name from classical Ullmann coupling -- a nucleophilic substitution reaction between aromatic halides that proceeds in solution in the presence of metallic copper and leads to the formation of a carbon-carbon bond between two aromatic carbon atoms. 
...
This well-established ability of the classical Ullmann reaction to couple aromatic carbons and thus their $\pi$ systems has been adapted to assemble $\pi$-conjugated nanomaterials on metal surfaces, which serve as both a low-dimensional confining template and catalyst.
...
The mechanism of Ullmann coupling has been studied with a variety of experimental techniques, of which STM, AFM and {\comm[RZK0619: Any other?]} prove most useful. These studies are often augmented by computational research crucial for interpreting ambiguous experimental data.
%
...
Although substantial progress has been made elucidating the mechanism of Ullmann coupling, our knowledge of many details remains incomplete. Experimental data has been interpreted based almost exclusively on computer models that describe metal surfaces as ideal, perfectly ordered structures. 
%
...
It is well known that adatoms are created on clean copper, silver and gold surfaces~\cite{ullmann_79, ullmann_58}, especially near terrace edges and kinks~\cite{ullmann_84, ullmann_85}, in the process of thermal motion. 
...
For example, DFT modeling shows that two large bromofluoranthene groups lift their shared gold atom \SI{2.2}{\angstrom} above its ideal surface position, which is noticeably higher than the \SI{0.5}{\angstrom} raise produced by a single group~\cite{jpcc2018} and than the radius of the metal atom.
...
In order to answer these questions, this work utilizes DFT modeling to examine the energetics of the adatom creation during the Ullmann reaction of two phenyl groups on Cu(111), Ag(111) and Au(111) surfaces for the first time. 

...
\begin{tabular}{ |p{3cm}||p{1.5cm}|p{1.5cm}|p{1.5cm}|  }
 ...
 \hline
\end{tabular}
\caption{Energy barrier of halogens diffusing on different metal surfaces. RZK0426: The origin of this data (experiment, calculations?) is unclear, citation is missing. RZK0426: As Dima and I both said, all figure captions must contain references and, if required, publisher's permission.}
\label{table:1}
\end{table}

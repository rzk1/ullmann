...
%In the generalization of the Cu(111) data, the reason for the high barrier of the adatom-catalyzed C--C bond formation is the same: strengthening of adatom-phenyl bonds compared to surface-phenyl bonds. In fact there is a clear dependence between this strengthening and the increase in the C--C formation energy barrier from the ideal to adatom pathways (Fig.~\ref{RZK0806}).

%{\comm Any general chemistry explanations of this trend?}

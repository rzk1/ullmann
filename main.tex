...
A thorough understanding of the mechanism of surface Ullmann coupling reaction is essential for tuning reaction conditions and for rational, more precise design of monomers that produce polymers matching a chosen metal surface.
...
that include dehalogenation, diffusion and bridge formation, C-C bond formation

It should be noted that the surface Ullmann coupling proceeds through the formation of the organometallic intermediates similar to those encountered in the reaction in solution (Fig.~\ref{SI-fig:classical}).
...
The energy of the adatom formation during the dehalogenation step can be compared to the high \SI{1.76}{\electronvolt} energy of the adatom extraction on the clean metal surface (Fig.~\ref{fig:completeenergy}, RYK-green pathway). The extraction on the clean surface has higher/lower/similar activation energy of \SI{2.04}{\electronvolt} than/to . On the clean surface, the extracted adatom is located at the RYZ site (Fig.~\ref{SI-fig:cleanatomform}). Compare to the dehalogenation geometry. And so on.
...
Clean adatoms can be created if the monomers interact strongly.

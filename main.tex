...
As the data in Table.\ref{table:idealsurface} illustrate, final coupling step following ideal surface path (\textbf{CMC} to \textbf{DIM}) is highly exothermic, resulting in that biphenyl is the most thermodynamic stable species in along the RYK-black line in Fig.~\ref{fig:completeenergy}. In agreement with experiment, Ullmann coupling of bromobenzene will end in biphenyl and bromine atoms adsoprbed on Cu(111) at \SI{350}{\kelvin}\cite{ullmann_67}. Then higher annealing temperature leads to the desorption of biphenyl and eventually bromine gas.
This path offers a relatively small energy barrier, which is line with onset temperature for C--C bond formation from two phenyl radicals on Cu(111) is \SI{300}{\kelvin}~\cite{sur_sci01} in experiment.

The raised cooper atom in this path migrates back step by step.

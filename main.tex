...
The mechanism of the Ullmann coupling has been studied with a variety of experimental techniques, of which STM, AFM, photoemission tomography and {\comm[RZK0619: Any other?]} prove most useful. Experimental investigation is often augmented by computer modeling crucial for interpreting ambiguous experimental data.
%
...
\caption{
The frozen-nuclei interaction energy between the two phenyl groups and copper surface measured as the change from the \textbf{DHAL-2} state. Positive energy indicates stronger interactions. Atoms are fixed to estimate the interaction energy in the transition states.}

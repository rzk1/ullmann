...
The protopolymers have later been identified by Lipton-Duffin \textit{et al.} as periodic organometallic intermediates linked \textit{via} carbon-metal-carbon bonds~\cite{ullmann_88}.
...
RZK0426: Dima's comment: ``I would consider giving brief the details of calculations when citing the calc energies - to facilitate comparisons.'' If we add calculation details, this should be done consistently throughout the introduction, not in just this instance. For now, I will comment out the details to keep the description consistent with the rest of the introduction.
...
RZK0426: The result reported in pccp2010 for ideal-surface step is very different from our results. In their article this step is exothermic. This needs to be mentioned and perhaps discussed extensively.

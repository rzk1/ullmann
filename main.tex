...
Fig.~\ref{fig:bondformlift} demonstrated the CI-NEB calculation data and geometry transformation from C--Cu--C bridge intermediates (IM4) to final dimer on a perfect surface (Dim-g) along the green path. 
...
\caption{C-C bond formation through lifting Cu atom Path I. Left diagram is CI-NEB calculation, right part is the top and side view of $IM4$, $TS-g$, and $Dim-g$ in Fig.~\ref{fig:completeenergy}, sphere colors are set same as above.}
...
{\color{blue}
The red line in Fig.~\ref{fig:completeenergy} shows the path that an ideal surface Cu atom is fully extracted by the C--Cu--C bridge intermediates out of the first layer and become a new formed adatom with the formation of C--C bond. There exists two consecutive reactions in this path, the two transition states are explored individually. 
...
\subsection{Surface Ullmann coupling with a pre-existing adatom}
...
\caption{The energy diagram of bromobenzene on Cu(111) surface Ullmann coupling reaction with a pre-existing adatom. (Scarlet circle represents bromine atom).}

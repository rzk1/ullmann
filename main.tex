...
%
The energy barrier of the dehalogenation on Cu(111) surface decreases from chlorobenzene (\SI{1.25}{\electronvolt}) to bromobenzene (\SI{0.92}{\electronvolt}) and to iodobenzene (\SI{0.68}{\electronvolt}). The energy change in the dehalogenation step is \SI{-0.58}{\electronvolt}, \SI{-0.80}{\electronvolt} and \SI{-0.94}{\electronvolt} for chlorobenzene, bromobenzene and iodobenzene, respectively. 

...
In the dehalogenation step, the CI-NEB method was used in chlorobenzene, bromobenzene and iodobenzene precursors to study how different halogens will affect on the dissociation of carbon-halogen bonds. CI-NEB method provides energy profile diagram as well the transition state.

%Choice for the zero-energy state.
Clean, ideal Cu(111) surface with a halobenzene in gas phase (not physisorbed) is chosen to be zero-energy state among all intermediates involved in surface Ullmann coupling process. Energies of other intermediates are presented with relative values.
}

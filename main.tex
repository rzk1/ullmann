...
\section{conclusions}
We have computationally investigated the surface Ullmann coupling reaction of chlorobenzene, bromobenzene and iodobenzene on commonly employed Cu(111) surface. Also the nature and origin of metal atom involved in each elementary step of forming biphenyl molecule are studied. Mainly the energy and molecular geometry of two different pathways: (1) a partially lifted up copper atom takes part in the formation of C--Cu--C bridge structure and back to it original position in first layer of surface with the construction of new C--C bond; (2) a copper atom and a vacancy is formed by fully extraction of C--Cu--C bridge structure, and a new adatom is created with forming C--C bond on copper surface are compared based on DFT calculation results.

It can be concluded that different halogens will mainly influence the dehalogenation step and produce little effect on later steps. The activation of dechlorination is the highest, debromination and deiodination are relatively lower, the data are consistent with the dehalogenation temperature in experiments. After forming C--Cu--C bridge intermediate structure, the path of partially lifting ideal surface atom is much more energetically favorable both in thermodynamics and kinetics, compared with the path of creating a new adatom. This suggests that Ullmann coupling on copper surface is more likely to occur through a non-adatom formation pathway, the metal atom will be partially lifted up while the C--Cu--C organometallic intermediates forms and back to its original position after completing the coupling reaction.

It should not rule out the possibility that adatoms will take part in the Ullmann coupling process. The path that adatom already exists from thermal fluctuation or defect before the coupling is not discussed. Pre-existing adatom is still a plausible source for organometallic intermediates in surface Ullmann coupling on metal surface.

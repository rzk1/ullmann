...
%RZK0815: Do not use double-hyphen in the x and y-axis labels in (b). Single hyphen is ok.
%RZK0815: Use the x-axis label from (b) in the y-axis label of (a).
...
\caption{RZK0815: The region of competitive Three metals according to the DFT calculated energetics of the unassisted and assisted adatom extraction. $\Delta$ refers to the change in the phenyl-metal binding from the ideal suface to adatom. Interestingly, } 
...
%RZK0815: Thanks! Can you also please let me know the font name, if python tells you?
